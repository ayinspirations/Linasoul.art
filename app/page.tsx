          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div className="relative">
              <div className="aspect-square overflow-hidden rounded-2xl shadow-2xl">
                <Image src="/images/lina-abstrakt-acrylmalerei-kuenstlerin.jpeg" alt="Lina im Atelier" width={1200} height={1200} className="w-full h-full object-cover object-bottom" />
              </div>
